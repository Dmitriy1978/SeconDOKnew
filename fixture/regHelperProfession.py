...
class regHelperProfession(base):
    ...
    institution_name = "html/body/div[2]/section[1]/div[6]/div[3]/div/div[5]/div/section/section/ng-include/div/div[8]/span"
    ...
    specialization_name = "//div[@class='db_item ng-binding ng-scope' and contains(text(), 'Toxicology')]"
